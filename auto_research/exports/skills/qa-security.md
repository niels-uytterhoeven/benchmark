---
name: qa-security
description: "Perform white-box security audit of web application source code for XSS, injection, credential exposure, and authentication/authorization flaws"
trigger: "when the user asks to find security vulnerabilities, XSS issues, or perform a security audit of a web application"
---
