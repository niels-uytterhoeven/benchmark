...
description: "Audit web application source code against WCAG 2.1 AA criteria including labels, ARIA, keyboard navigation, focus management, and screen reader support"
trigger: "when the user asks to audit accessibility, WCAG compliance, keyboard navigation, or screen reader support"
---
